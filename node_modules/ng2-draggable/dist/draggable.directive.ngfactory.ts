...
export class Wrapper_DraggableDirective {
  ...
  constructor(p0:any,p1:any) {
    this._changed = false;
    this.context = new import0.DraggableDirective(p0,p1);
  ...
  handleEvent(eventName:string,$event:any):boolean {
    ...
    if ((eventName == 'dragend')) {
      const pd_sub_1:any = ((<any>this.context.onDragEnd($event)) !== false);
      result = (pd_sub_1 && result);
    }
    if ((eventName == 'drag')) {
      const pd_sub_2:any = ((<any>this.context.onDrag($event)) !== false);
